...
class Paciente:
    def __init__(self, nm, em, dt_nasc, med):
        self.nome = nm
        self.email = em
...
'''
class Exame:
    def __init__(self, dt_rel, dthr_cons, rs, nm_ex, paci):
    ...
    def __str__(self):
        return f'''
                Exame realizado: {self.nome_exame}
...
p1 = Paciente("Maria", "ma@gmail.com", "24/03/1999", m1)
e1 = Exame("03/03/2026", "04/03/2026", "fratura no punho", "Raio-x", p1)
e2 = Exame("04/03/2026", "04/03/2026", "vbnhufgbvyfd", "A", p1)
